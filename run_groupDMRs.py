...
print(samples)
dms = d.DMRs()
(dm, qt_up, qt_down) = dms.groupDMRs(samples=samplist, sample_groups=group_names, coord=gc, chroms=chr_names, min_finite=[0.8,0.8], k=3, min_CpGs=min_CpGs, delta=delta)
